...
void oled_display_content(int max_difference, int interval_in_miliseconds, int time_diff, int analog_value_to_display, int record_min, int record_max, int current_difference) {
  display.clearDisplay();                           // Clear display buffer
  display.setTextSize(1);                           // Draw 2X-scale text
  display.setTextColor(SSD1306_WHITE);
