...
void handle_analogRead() 
{
  ...
  analog_value = reat_raw_value_adc1115();
  ...
  {
    analog_value_to_display = reat_raw_value_adc1115();
    current_difference = record_max-record_min;
    last_update_time_for_current_value=millis();
    V=reat_V_value_adc1115();
  }

    oled_display_content(max_difference,  interval_to_measure_max_difference,   current_time-last_update_time_for_max_value,   analog_value_to_display,  record_min,  record_max, current_difference ,V);
